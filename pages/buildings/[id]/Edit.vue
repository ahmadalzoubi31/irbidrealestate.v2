...
const { data: building, status } = await getOneBuilding(
      ...
      <div class="grid grid-cols-6 gap-x-6 gap-y-4">
        ...
        <div class="col-span-6 sm:col-span-2">
          ...
          <UInput
            ...
            :size="'sm'"
            :required="true"
            v-model="state.apartmentsCount"
          />
        </div>

        <!-- storeCount -->
        <div class="col-span-6 sm:col-span-2">
          <label for="storeCount"
            >عدد المخازن
            <span class="text-sm text-primary-500">(إن وجدت)</span></label
          >
          <UInput
            id="storeCount"
            name="storeCount"
      ...
      <div class="grid grid-cols-6 gap-x-6 gap-y-4">
        ...
        <div class="col-span-6 sm:col-span-2">
          ...
          <UInput
            ...
            :size="'sm'"
            :required="false"
            v-model="state.maintenanceAmount"
          />
        </div>
        <!-- maintenancePaidBy -->
        <div class="col-span-6 sm:col-span-2">
