  ...
  <UContainer>
        ...
        <div class="relative flex w-full items-center justify-center xl:justify-between h-20">
          <div class="flex w-full items-center justify-center xl:items-stretch xl:justify-between">
            <div class="flex-shrink-0 flex w-full items-center justify-between">
              <h1 class="text-white text-xl font-bold">مؤسسة<span class="text-primary-300 font-bold"> اربد
                  العقارية.</span></h1>
              <div id="logo">
    ...
    <body>
      <div id="contentWrapper">
        ...
        <section class="bg-white rounded-lg p-6 mb-4">
        ...
        <section class="bg-white rounded-lg p-6 mb-4">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <img src="https://via.placeholder.com/300" alt="Apartment Photo"
        ...
        <section class="bg-white rounded-lg p-6 mb-4">
          ...
          <div class="grid ">
            <img src="https://placehold.co/1200x600" alt="Apartment Photo"
              class="rounded-lg shadow-md object-cover" />
          </div>
        </section>
      </div>
    ...
    <footer>
      <div class="relative mt-16 bg-primary-500">
        <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-primary-500" preserveAspectRatio="none"
          viewBox="0 0 1440 54">
          ...
          <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="sm:col-span-2">
              ...
              <div class="mt-4 lg:max-w-sm">
                <p class="text-sm text-primary-50">
                  رؤيتنا هي العمل على توفير افضل الفرص العقارية والاستثماريه للعميل "تاجير وبيع جميع العقارات والاراضي
                  التجاريه وتصميم كل
                  ما يخص العقارات "
                </p>
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex">
                ...
                <a href="tel:07-7110-8080" aria-label="Our phone" title="Our phone"
                  class="transition-colors duration-300 text-primary-50 hover:text-gray-700">0771108080</a>
              </div>
              <div class="flex">
                <p class="mr-1 text-gray-700">الايميل:</p>
                <a href="mailto:irbidrealestate@gmail.com" aria-label="Our email" title="Our email"
                  class="transition-colors duration-300 text-primary-50 hover:text-gray-700">irbidrealestate@gmail.com</a>
              </div>
              <div class="flex">
                <p class="mr-1 text-gray-700">العنوان:</p>
                <a href="https://maps.app.goo.gl/um5hDbeYpT9HBGC99" target="_blank" rel="noopener noreferrer"
