...
const { updateServiceStatus } = useUseServiceActions();
...
const saveServiceStatus = async () => {
  isLoading.value = true;
  updateServiceStatus(updatedServices.value);
};
</script>

<template>
  <div>
    <h1 class="text-lg my-4">تتبع دفعات الخدمات</h1>
    <div>
