...
const submitForm = async () => {
  ...
  if (!state.name || !state.name || !state.number || state.adId == 0) {
    toast.add({
    ...
    <div class="pt-6 pb-8 space-y-2">
      <div class="grid grid-cols-6 gap-x-6 gap-y-4">
        ...
        <div class="col-span-6 sm:col-span-2">
          ...
          <USelectMenu id="ad" name="ad" v-model="state.adId" :required="true" :options="computedAds" value-attribute="id" option-attribute="name" />
        </div>
        <!-- name -->
        <div class="col-span-6 sm:col-span-2">
        ...
        <!-- number -->
        <div class="col-span-6 sm:col-span-2">
          <label for="number">اسم الشخص <span class="text-sm text-primary-500">(اجباري)</span></label>
